// DB-HS5 — Metadatos + geometría NO-COMPONENTE del render SVG (sin JSX). Separado
...
// función PURA) y `hs5NativeSize`. Lo consumen el render (`svg.tsx`), la ficha PDF
...
import type { HS5Result, ResultadoTramo } from "./calc";
...
// -----------------------------------------------------------------------------
export const COL_W = 76; // ancho de columna (separación horizontal entre hojas)
export const ROW_H = 64; // alto de fila (separación vertical entre niveles)
export const NODE_W = 64; // ancho útil de la caja de etiquetas de un tramo
...
export const NODE_BOX_H = 40; // alto del recuadro de etiquetas
 ...
 */
export function calcularArbol(result: HS5Result): ArbolGeom {
