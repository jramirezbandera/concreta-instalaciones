...
function applyTheme(theme: Theme): void {
  ...
  // Suprimir transiciones durante el swap: añadir la clase, cambiar las vars, y
  // forzar un reflow para que el estado "sin transición" se aplique ANTES de que
  // cambien los colores. Se re-habilitan en el siguiente frame (las transiciones
  // de hover normales siguen funcionando). Evita que unos elementos animen y
  // otros no al togglear el tema.
  root.classList.add("theme-switching");
  root.dataset.theme = theme;
  const meta = document.querySelector('meta[name="theme-color"]');
  if (meta) meta.setAttribute("content", META_COLOR[theme]);
  // Lectura que fuerza el reflow (descartar el valor es intencionado).
